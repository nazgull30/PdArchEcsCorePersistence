...
<p align="center">
<img alt="PdArchEcsCorePersistence" src="PdArchEcsCorePersistence/icon.png" width="200">
</p>
...
dotnet new --install PdArchEcsCorePersistence
...
You can debug the included test project for your package in `PdArchEcsCorePersistence.Tests/` by opening the root of this repository in VSCode and selecting one of the launch configurations: `Debug Tests` or `Debug Current Test`.
...
By default, a test project in `PdArchEcsCorePersistence.Tests/` is created for you to write tests for your package. [GoDotTest] is already included and setup, allowing you to focus on development and testing.
...
# Run code coverage:
cd PdArchEcsCorePersistence.Tests
./coverage.sh
```
...
Tests are executed by running the Godot test project in `PdArchEcsCorePersistence.Tests` from the command line and passing in the relevant arguments to Godot so that [GoDotTest] can discover and run tests.
...
[line-coverage]: PdArchEcsCorePersistence.Tests/badges/line_coverage.svg
[branch-coverage]: PdArchEcsCorePersistence.Tests/badges/branch_coverage.svg
